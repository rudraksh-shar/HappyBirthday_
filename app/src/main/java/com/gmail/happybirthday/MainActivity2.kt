...
class MainActivity2 : AppCompatActivity() {
    ...
    fun Createcard(view: View) {
        ...
        val mp = MediaPlayer.create(this@MainActivity2, R.raw.mmusic)
        mp.start()

        val name = nameInput.editableText.toString() // this extract the string from the id called nameInput

        val toast = Toast.makeText(this@MainActivity2, "name is $name", Toast.LENGTH_SHORT) // this makes a toast
        ...
        val intent = Intent(this@MainActivity2, BirthdayGreetingActivity::class.java)
